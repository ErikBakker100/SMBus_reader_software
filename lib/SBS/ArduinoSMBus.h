...
struct ManufacturerBatStatus {
  uint16_t raw;                 /**< Data Read. */
  bool wakeup;                  /**< 0,0,0,0 = Wake Up. */
  bool normaldischarge;         /**< 0,0,0,1 = Normal Discharge. */
  bool precharge;               /**< 0,0,1,1 = Pre-Charge. */
  bool charge;                  /**< 0,1,0,1 = Charge. */
  bool chargetermination;       /**< 0,1,1,1 = Charge Termination. */
  bool faultchargeterminate;    /**< 1,0,0,0 = Fault Charge Terminate. */
  bool permanentfailure;        /**< 1,0,0,1 = Permanent Failure. */
  String failure {""};
  bool overcurrent;             /**< 1,0,1,0 = Overcurrent. */
  bool overtemperature;         /**< 1,0,1,1 = Overtemperature. */
  bool batteryfailure;          /**< 1,1,0,0 = Battery Failure. */
  bool sleep;                   /**< 1,1,0,1 = Sleep. */
  bool batteryremoved;          /**< 1,1,1,1 = Battery Removed. */
